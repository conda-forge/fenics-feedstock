...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/fenics-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fenics-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add fenics fenics-dolfin fenics-libdolfin
# for installing globally
pixi global install fenics fenics-dolfin fenics-libdolfin
```
...
It is possible to list all of the versions of `fenics` available on your platform:
...
```
pixi search fenics --channel conda-forge
```
